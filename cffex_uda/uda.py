...
from cffex_uda.albert import optimization
from cffex_uda.utils import tpu_utils
...
def hidden_to_logits(hidden, is_training, num_classes, scope):
  ...
  with tf.variable_scope(scope, reuse=tf.AUTO_REUSE):
    ...
    print("hidden: {}, hidden.shape.ndims: {}".format(hidden,
                                                      hidden.shape.ndims))
    print("output_weights: {}".format(output_weights))
